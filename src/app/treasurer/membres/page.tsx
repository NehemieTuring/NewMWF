   ...
   return (
      <div className={styles.container}>
         ...
         <div className={styles.tableCard}>
            <table className={styles.table}>
               <thead>
                  <tr>
                     <th>Nom & Prénom</th>
                     <th>Contact</th>
                     <th style={{ textAlign: "right" }}>Épargne Totale</th>
                     ...
                     <tr key={m.id} style={{ cursor: "pointer" }} onClick={() => viewMemberDetails(m)}>
                        ...
                        <td style={{ textAlign: "center" }}>
                           {!m.active ? (
                              ...
                              <span className={`${styles.badge} ${m.calculatedStatus === 'EN_REGLE' ? styles.badgeSuccess : (m.calculatedStatus === 'INACTIF' ? styles.badgeDanger : styles.badgeWarning)}`}>
                                 {m.calculatedStatus === 'EN_REGLE' ? 'EN REGLE' : (m.calculatedStatus === 'INACTIF' ? 'INACTIF' : 'INSOLVABLE')}
                              </span>
                           )}
                        </td>
            ...
            {filteredMembers.length === 0 && <div style={{ padding: "4rem", textAlign: "center", color: "#858796" }}>Aucun membre trouvé.</div>}
         </div>
               ...
               <div className={styles.modal} style={{ maxWidth: "800px", width: "95%", maxHeight: "90vh", display: "flex", flexDirection: "column" }} onClick={(e) => e.stopPropagation()}>
                  ...
                  <nav style={{
                     ...
                     {["profil", "epargne", "dettes", "emprunts"].map((tab) => (
                        ...
                        >
                           {tab === "epargne" ? "Épargne" : tab.charAt(0).toUpperCase() + tab.slice(1)}
                        </button>
                     ))}
                  </nav>
